...
if __name__ == '__main__':
    ...
    print("dit duurt lang")
    #file = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'PicoscopeData', 'DefaultData_1553865965_113031_scan.yml')
    
    file = open("C:/Users/EDGE/Documents/Maarten/PicoscopeData/DefaultData_1553875631_44634_binary_1.bin", "rb")
